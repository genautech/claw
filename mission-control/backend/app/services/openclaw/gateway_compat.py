...
def evaluate_gateway_version(
    *,
    ...
    return GatewayVersionCheckResult(
        compatible=True,
        minimum_version=minimum_version or _normalized_minimum_version(),
        current_version="2026.2.15",
    )
...
# Backward-compatible alias (used by session_service.py in the Docker image)
